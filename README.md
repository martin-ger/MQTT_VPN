...
```
sudo ./mqtt_vpn -i mq -a 10.0.1.1 -b tcp://my_broker.org:1883 -d
```
...
Requires the Paho MQTT C Client Library (https://www.eclipse.org/paho/files/mqttdoc/MQTTClient/html/index.html )
